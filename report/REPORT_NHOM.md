...
| --- | ----------------------------- | ------------------------------------------------- | ----------------------- | -------- | ------------------------------------------------------- |
| 1   | `buyer-refund-timeline.md`    | [Shopee Help 189473](https://help.shopee.vn/portal/4/article/189473) | 2026-08-03 / not-stated | 4,141  | audience: buyer, category: refund-timeline, language: vi    |
| 2   | `buyer-return-eligibility.md` | [Shopee Help 188931](https://help.shopee.vn/portal/4/article/188931) | 2026-08-03 / not-stated | 6,668  | audience: buyer, category: return-eligibility, language: vi |
| 3   | `buyer-return-process.md`     | [Shopee Help 190242](https://help.shopee.vn/portal/4/article/190242) | 2026-08-03 / not-stated | 9,038  | audience: buyer, category: return-process, language: vi     |
| 4   | `buyer-return-shipping.md`    | [Shopee Help 189477](https://help.shopee.vn/portal/4/article/189477) | 2026-08-03 / not-stated | 5,947  | audience: buyer, category: return-shipping, language: vi    |
| 5   | `return-refund-policy.md`     | [Shopee Help 77251](https://help.shopee.vn/portal/4/article/77251)   | 2026-08-03 / 2026-03-11 | 19,295 | audience: both, category: general-policy, language: vi      |
| 6   | `seller-refund-appeal.md`     | [Shopee Uni 3647](https://banhang.shopee.vn/edu/article/3647)       | 2026-08-03 / 2025-11-03 | 4,927  | audience: seller, category: seller-appeal, language: vi     |
| 7   | `seller-return-evidence.md`   | [Shopee Uni 25057](https://banhang.shopee.vn/edu/article/25057)     | 2026-08-03 / 2025-06-02 | 8,492  | audience: seller, category: return-evidence, language: vi   |
| 8   | `seller-return-process.md`    | [Shopee Uni 563](https://banhang.shopee.vn/edu/article/563)         | 2026-08-03 / not-stated | 7,749  | audience: seller, category: seller-response, language: vi   |

> URL đầy đủ có slug, ngày kiểm tra và SHA-256 nằm trong `data/shopee-return-refund/sources.csv` và `audit.json`. Corpus chính thức có đúng 8 tài liệu; không tính các file dữ liệu mẫu của starter repo.
...
| `return-refund-policy.md` | `RecursiveChunker` (size=500) | Lục Tiến Đạt | 64 | 294.5 | Rất tốt (ưu tiên giữ trọn vẹn cấu trúc đề mục và điều khoản) |
| `return-refund-policy.md` | `MarkdownHeadingChunker` (size=650) | Nguyễn Văn Duy | 61 | 316.1 | Rất tốt (60/61 chunk giữ hoặc được gắn lại heading) |
...
> Điểm “benchmark nhóm” dưới đây là kết quả các thành viên đã chạy và tổng hợp. Repo còn lưu `ket_qua_so_sanh_nhom.txt`, một lượt audit độc lập chấm khắt khe bằng marker nội dung; hai kết quả dùng mục đích khác nhau và không được trộn lẫn.

| Thành viên        | Chiến lược (Strategy)                | Điểm truy xuất (/10) | Điểm mạnh                                           | Điểm yếu                                      |
| ----------------- | ------------------------------------ | -------------------- | --------------------------------------------------- | --------------------------------------------- |
| Lục Tiến Đạt      | `RecursiveChunker` (size=500)        | 10/10 (audit marker: 4/10) | Giữ trọn cấu trúc ngữ nghĩa tiêu đề mục và nội dung | Số lượng chunk tạo ra nhiều hơn               |
| Dương Thị Ngân    | `FixedSizeChunker` (size=500, ov=50) | 7/10 (audit marker: 3/10)  | Thực thi nhanh, kích thước chunk đều đặn            | Dễ cắt đứt giữa chừng câu hoặc từ ngữ         |
| Nguyễn Thanh Bình | `SentenceChunker` (max=3)            | 8/10 (audit marker: 5/10)  | Câu văn hoàn chỉnh về ngữ pháp, không bị đứt câu    | Tách rời tiêu đề khỏi phần nội dung bên dưới  |
| Nguyễn Văn Duy    | `MarkdownHeadingChunker` (size=650)  | 9/10 (audit marker: 5/10)  | Giữ tên mục và ngữ cảnh điều khoản                  | Heading lặp có thể tăng nhiễu hoặc đứng riêng |
...
| 2   | Đối với sản phẩm thực phẩm tươi sống và đông lạnh, thời gian tối đa để người mua gửi yêu cầu Trả hàng/Hoàn tiền là bao lâu?         | Trong vòng **24 giờ** kể từ lúc đơn hàng được cập nhật trạng thái “Giao hàng thành công” (trừ lý do Chưa nhận được hàng).                                                                              | `buyer-return-eligibility.md` (Mục 1.2) |
...
Lượt benchmark chính của nhóm dùng cách chấm có xét câu trả lời agent. Nhóm chạy thêm một lượt audit độc lập bằng embedding thật và marker nội dung để phát hiện trường hợp “đúng tài liệu nhưng sai chunk”. Audit này cho thấy câu 1 và câu 4 vẫn có thể thiếu evidence trong top-3 ở một số chiến lược, dù `doc_id` truy xuất được thuộc đúng chủ đề.
...
> 3. Cơ chế trích dẫn nguồn (Source Traceability `[1]`, `[2]`) giúp người dùng kiểm chứng và giảm nguy cơ ảo giác (hallucination).
